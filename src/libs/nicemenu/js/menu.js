	...
	if(typeof(this.initialized == "undefined")){
		this.nm_createMenu = function()
		{
			...
			for(var i = 0; i < itemCount; i++)
			{
				...
				//绑定click事件
				if(typeof(this.menuClickEvent == "undefined")) {
					liNode.addEventListener("click", this.menuClickEvent);
				}
				var lir = 0;
				var lis = 0;
				switch(this.distributionType)
				...
				liNode.style.cssText += "-ms-transform:rotate(" + lir + "deg) skew(" + lis + "deg) scale(1.55);-ms-transform-origin: 100% 100%;";
				...
				aNode.onclick = this.chooserclick;
